...
class DescuentoAdicionalsControllerTest < ActionController::TestCase
  ...
  test "should create descuento_adicional" do
    assert_difference('DescuentoAdicional.count') do
      post :create, descuento_adicional: { descuento_adicional: @descuento_adicional.descuento_adicional, detalle_descuento: @descuento_adicional.detalle_descuento }
    end
  ...
  test "should update descuento_adicional" do
    patch :update, id: @descuento_adicional, descuento_adicional: { descuento_adicional: @descuento_adicional.descuento_adicional, detalle_descuento: @descuento_adicional.detalle_descuento }
    assert_redirected_to descuento_adicional_path(assigns(:descuento_adicional))
  end
